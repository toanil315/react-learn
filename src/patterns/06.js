...
const MediumClap = ({ children }) => {
  ...
  const { clapRef, clapCountRef, clapCountTotalRef } = DomRef;
...
MediumClap.Total = ClapTotalCount;

const MediumClapCompound = () => {
  return (
    <MediumClap>
      <MediumClap.Icon />
      <MediumClap.Count />
...
export default MediumClapCompound;
